...
class DocumentPolicy
{
    ...
    {
        return $user->hasRole(RolesEnum::Director->value) || $user->hasRole(RolesEnum::RHResponsableResourceHumaine->value) || $user->hasRole(RolesEnum::DirecteurAdjoint->value) || $user->hasRole(RolesEnum::Secretary->value) || $user->hasRole(RolesEnum::SecretaryGeneral->value);
    }
    ...
    {
        return $user->hasRole(RolesEnum::Director->value) || $user->hasRole(RolesEnum::RHResponsableResourceHumaine->value) || $user->hasRole(RolesEnum::DirecteurAdjoint->value) || $user->hasRole(RolesEnum::Secretary->value) || $user->hasRole(RolesEnum::SecretaryGeneral->value) || $user->id === $document->user_id;
    }
